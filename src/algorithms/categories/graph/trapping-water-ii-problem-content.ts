...
export const TRAPPING_WATER_II_CODE_LANGUAGES: Record<string, string[]> = {
  ...
  python: [
    '# 二维接雨水 II (Python 标准实现)',
    '# 核心原理: 木桶短板效应 + 优先队列小根堆由外向内收缩',
    ...
    '                    ans += w - height_map[nr][nc]  # 洼地蓄水',
    '                # 新木板高度为 max(当前水线, 邻居自身高度)',
