...
export const KONIG_COVER_CODE_LANGUAGES = KONIG_CODE_LANGUAGES;
export const KONIG_COVER_PROBLEM_HTML = KONIG_PROBLEM_HTML;
export const KONIG_COVER_ANALYSIS_HTML = KONIG_ANALYSIS_HTML;
