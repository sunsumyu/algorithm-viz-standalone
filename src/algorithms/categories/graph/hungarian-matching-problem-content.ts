...
export const HUNGARIAN_CODE_LANGUAGES: Record<string, string[]> = {
  ...
  java: [
    ...
    '    public static boolean dfs(int u, ArrayList<ArrayList<Integer>> graph, int[] match, boolean[] visited) {',
    ...
    '    }',
    '    ',
    '    public static int maxMatching(int nLeft, int nRight, ArrayList<ArrayList<Integer>> graph) {',
  ...
  python: [
    ...
    '    :param n_left: 左部顶点数',
    '    :param n_right: 右部顶点数',
    '    :param graph: 邻接表表示 graph[u] = [v1, v2, ...]',
    '    :return: 最大二分匹配数',
    '    """',
    '    match = [-1] * n_right',
    '    ',
  ...
  javascript: [
    ...
    ' * @param {number} nLeft 左部节点数量',
    ' * @param {number} nRight 右部节点数量',
