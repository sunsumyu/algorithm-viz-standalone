...
export function buildBuyGoodsRecursionSteps(initialBudget: number, a: number[], b: number[], w: number[], maxSteps = 800) {
  ...
  const lineMap: Record<string, HighlightTarget> = {
    callRoot: { java: 21, cpp: 19, python: 19, javascript: 15 },
    fnEnter: { java: 23, cpp: 6, python: 13, javascript: 9 },
    baseCheck: { java: 24, cpp: 7, python: 14, javascript: 10 },
    branch1: { java: 25, cpp: 8, python: 16, javascript: 11 },
    branch2: { java: 26, cpp: 9, python: 17, javascript: 12 },
    returnMax: { java: 27, cpp: 10, python: 18, javascript: 13 },
  };
...
export function buildBuyGoodsMemoSteps(initialBudget: number, a: number[], b: number[], w: number[], maxSteps = 800) {
  ...
  const lineMap: Record<string, HighlightTarget> = {
    callRoot: { java: 23, cpp: 19, python: 20, javascript: 16 },
    fnEnter: { java: 25, cpp: 6, python: 13, javascript: 9 },
    baseCheck: { java: 26, cpp: 7, python: 14, javascript: 10 },
    memoCheck: { java: 27, cpp: 8, python: 16, javascript: 11 },
    branch1: { java: 28, cpp: 9, python: 18, javascript: 12 },
    branch2: { java: 29, cpp: 10, python: 19, javascript: 13 },
    memoStore: { java: 30, cpp: 11, python: 20, javascript: 14 },
  };
...
export function buildBuyGoods2DSteps(initialBudget: number, a: number[], b: number[], w: number[]) {
  ...
  const lineMap: Record<string, HighlightTarget> = {
    initDp: { java: 22, cpp: 15, python: 14, javascript: 11 },
    outerLoopI: { java: 23, cpp: 16, python: 15, javascript: 12 },
    innerLoopJ: { java: 26, cpp: 18, python: 17, javascript: 14 },
    inheritNoPick: { java: 27, cpp: 19, python: 18, javascript: 15 },
    updatePick: { java: 29, cpp: 20, python: 20, javascript: 16 },
    returnAns: { java: 33, cpp: 23, python: 21, javascript: 19 },
  };
