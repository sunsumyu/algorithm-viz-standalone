...
export class SequenceDeleteDistanceStrategy implements IAlgorithmStrategy {
  ...
  public generateStage1or2(
    ...
    return SequenceStepMatrixCompiler.compileDeleteDistanceStage1or2(model, isMemo, anchorMap, direction);
  }
  ...
  public generateStage3(
    ...
    return SequenceStepMatrixCompiler.compileDeleteDistanceStage3(model, anchorMap, direction);
  }
  ...
  public generateStage4(
    ...
    return SequenceStepMatrixCompiler.compileDeleteDistanceStage4(model, anchorMap, direction);
  }
}
