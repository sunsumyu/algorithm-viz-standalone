...
export class SequenceDistinctSubsequencesStrategy implements IAlgorithmStrategy {
  ...
  public generateStage1or2(
    ...
    return SequenceStepMatrixCompiler.compileDistinctSubsequencesStage1or2(model, isMemo, anchorMap);
  }
  ...
  public generateStage3(
    ...
    return SequenceStepMatrixCompiler.compileDistinctSubsequencesStage3(model, anchorMap);
  }
  ...
  public generateStage4(
    ...
    return SequenceStepMatrixCompiler.compileDistinctSubsequencesStage4(model, anchorMap);
  }
}
